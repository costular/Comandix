...
class BillFragment : BaseListFragment() {
    ...
    override fun getAdapter(): RecyclerView.Adapter<*> {
        val dishAdapter = DataBindingRecyclerAdapter<Order>(BR.order, R.layout.item_order)
        dishAdapter.items.addAll(getOrder())
        dishAdapter.notifyDataSetChanged()

        return dishAdapter
    }

    fun getOrder() : ArrayList<Order> {
        return arrayListOf(Order("5a21450841e27d2fac03108a",
                                    "Poco hecho",
                                    3,
                                    "5a2144a341e27d2fac031089",
                                    "5a213ba941e27d2fac031084",
